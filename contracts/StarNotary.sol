...
contract StarNotary is ERC721 {
    ...
    constructor() ERC721("To The Stars", "TTS") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "Error: Neither address is the Star owner."
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            msg.sender == currentOwnerAddress,
            "Error: Cannot transfer a Star you do not own."
        );
        _transfer(currentOwnerAddress, _to1, _tokenId);
    }
}
